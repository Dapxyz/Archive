...
$name = $username = $email = ''; // Inisialisasi variabel
if (isset($_POST['submit'])) {
    ...
    if ($password == $cpassword) {
        ...
        if ($result && mysqli_num_rows($result) == 0) { // Check if email is not already registered
    ...
    <div class="container">
        <form action="" method="POST" class="login-email">
            ...
            <div class="input-group">
                <input type="text" placeholder="Name" name="name" value="<?php echo htmlspecialchars($name); ?>" required>
            </div>
            <div class="input-group">
